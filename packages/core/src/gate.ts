import type { ActionId, BotId, RunId } from './identity.ts';
...
export interface GateRuntimePorts { botId: BotId; attachments: Pick<AttachmentPort, 'ingest' | 'open' | 'list'>; actions: ActionPort }
